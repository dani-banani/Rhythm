execute unless predicate dani:player/flags/sneaking summon marker run function dani:rhythm/entity/marker/projectile/summon {lifeTime: 40, Tags: [""], ID: 1, jinki_type: 1, tp: "~ ~1.6 ~", rotation: "~ ~", command: "scoreboard players set $const.1 dani.Global 1"}
