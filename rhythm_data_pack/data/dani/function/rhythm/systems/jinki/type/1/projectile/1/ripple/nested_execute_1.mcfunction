...
execute summon marker run function dani:rhythm/entity/marker/projectile/summon {name:"Ripple",lifeTime: 10, Tags: ["lookatme"], ID: 2, jinki_type: 1, tp: "~ ~ ~", rotation: "~ 0", command: "function dani:rhythm/systems/jinki/type/1/projectile/1/ripple_init"}
